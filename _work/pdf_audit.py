...
SUBJECTS = {
    ...
    'emg':     ('現場でいきる救急（表紙2026）.pdf', '救急'),
    'psy':     ('MECマイナー講座・精神科_問題（表紙2026）.pdf', '精神科'),
    'derm':    ('MECマイナー講座・皮膚科_問題（表紙2026）.pdf', '皮膚科'),
    'oph':     ('MECマイナー講座・眼科_問題（表紙2026）.pdf', '眼科'),
    ...
    'rad':     ('MECマイナー講座・放射線科_問題（表紙2026）.pdf', '放射線科'),
    # ⚠️ 中毒・職業病はマイナー講座ではなく横断テーマの独立PDF（画像は0枚）。
    'tox':     ('中毒・職業病（表紙2026）.pdf', '中毒・職業病'),
    # ⚠️ 公衆衛生はマイナー講座ではなく独立講座で、**PDFが2冊ある**（問題＋レジュメ）。
    #    設問の正本は問題PDFなのでこちらを登録する（解説の下敷きがレジュメ）。
    'ph':      ('MEC公衆衛生講座_問題（表紙2026）.pdf', '公衆衛生'),
