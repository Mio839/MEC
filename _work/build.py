...
SUBJECTS = [
    ("内分泌",  "内分泌",  "endo",   "内分泌",  "⚗️",  "#169E9F"),
    ("呼吸器",  "呼吸器",  "resp",   "呼吸器",  "🌬️",  "#4390EE"),
    ("循環器",  "循環器",  "circ",   "循環器",  "❤️",  "#E16E33"),
    ("消化器",  "消化器",  "dige",   "消化器",  "🌿",  "#8A81EF"),
    ("神経",    "神経",    "neur",   "神経",    "🧠",  "#619E37"),
    ("肝胆膵",  "肝胆膵",  "hbp",    "肝胆膵",  "🧪",  "#C0820E"),
    ("腎臓",    "腎臓",    "jinzo_d","腎臓",    "💧",  "#7494A1"),
    ("血液",    "血液",    "hema",   "血液",    "🩸",  "#E56574"),
]
