...
※ 皮膚科は2026-07-29に第8章まで完成（全9章249問の予定・残りは第9章27問）。章を足すたびに
　 `gamify.js` の `total`・`chapters_meta.js`・`study.html` の `subj-hdr-count` を実数へ更新すること。
