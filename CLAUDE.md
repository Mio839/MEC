...
| 泌尿器科（マイナー講座） | uro | 1／6 | 44（全6章242問の予定） |
| 実力試験Ⅰ | jitsu1 | 2 | 160 |
...
※ 泌尿器科は2026-08-11に第1章「泌尿器の基本」44問を追加（全6章242問の予定：基本44／腎25／尿管膀胱尿道64／前立腺53／精巣外性器28／感染症28）。`study.html` の科目ヘッダは実数（44問）を出す。
