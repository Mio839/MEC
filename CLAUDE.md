...
| 整形外科（マイナー講座） | ortho | 4／6 | 139／174（進行中） |
| 実力試験Ⅰ | jitsu1 | 2 | 160 |
...
※ 整形外科は2026-08-12に第1章「整形外科の基本」30問・第2章「神経の障害」43問・第3章「関節疾患」33問・第4章「骨　折」33問を追加（全6章174問の予定＝基本30／神経の障害43／関節疾患33／骨折33／その他27／ロコモ8）。`study.html` の科目ヘッダは実数（現在139問）を出す。章を足すたびに実数へ更新すること。
