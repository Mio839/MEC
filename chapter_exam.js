...
(function () {
  ...
  function injectCSS() {
    ...
    s.textContent = [
      ...
      /* progress bar */
      '#chExamProg{display:none;align-items:center;gap:4.8px;padding:0.6px 14px;background:rgba(0,0,0,.55);color:#fff;font-size:6.6px;font-weight:700;position:sticky;top:var(--ch-sn-h,0px);z-index:99;}',
      ...
      '.qc.ce-sink .ch2{transition:none;opacity:1;filter:none;transform:none;}',
      '.qc.ce-sink .ch2:not(.ch-exam-selected):not(.ch-exam-instant-correct):not(.ok){transform:none;opacity:1;filter:none;}',
