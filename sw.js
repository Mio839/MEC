// 2026-08-23a: 学習ハブ巨大歯車アニメーション強化 & テーマ別専用アニメーション（Brass歯車限定化・Aurora偏光クリスタル・CyberホログラムHUD・Liquid二重流体ジェル）完全実装。
//   - Brass: 巨大主歯車の多重立体陰影・ベベルエンボス調ゴールドリム・四隅連動小歯車の銅/真鍮コントラスト・噛み合い深度・高速逆回転。他テーマでは歯車を完全非表示化。
...
const SHELL_VERSION = "2026-08-23a";
