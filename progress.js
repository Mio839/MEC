...
(function () {
  ...
  const SID_NAMES = {
    ...
    peds:'小児科', obg:'産婦人科', psy:'精神科', derm:'皮膚科', oph:'眼科', ent:'耳鼻咽喉科', uro:'泌尿器科', ortho:'整形外科', anes:'麻酔科', rad:'放射線科', tox:'中毒・職業病', emg:'救急', ph:'公衆衛生', hisshu:'必修講座', jitsu1:'実力試験', custom:'自作', memo:'暗記メモ'
  };
